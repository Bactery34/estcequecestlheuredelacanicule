...
final case class Weather(city: String, temperatureC: BigDecimal, temperatureF: BigDecimal, time: LocalDateTime)
...
object Weather extends JsonHelpers {
  ...
  } yield Weather(name, temperatureC, temperatureF, time)
